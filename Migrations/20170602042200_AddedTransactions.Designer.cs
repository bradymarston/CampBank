...
namespace CampBank.Migrations
{
    ...
    [Migration("20170602042200_AddedTransactions")]
    partial class AddedTransactions
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CampBank.Core.Model.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CampBank.Core.Model.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CampBank.Core.Model.Transaction", b =>
                {
                    b.HasOne("CampBank.Core.Model.Kid", "Kid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CampBank.Core.Model.ApplicationUser")
                        .WithMany("Claims")
